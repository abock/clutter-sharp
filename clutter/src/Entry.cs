	...
	public  class Entry : Clutter.Actor {
		...
		public string FontName {
			...
			set  {
				...
				clutter_entry_set_font_name(Handle, font_name_as_native);
				GLib.Marshaller.Free (font_name_as_native);
			}
		}
		...
		public string Text {
			...
			set  {
				...
				clutter_entry_set_text(Handle, text_as_native);
				GLib.Marshaller.Free (text_as_native);
			}
		}
		...
		[GLib.CDeclCallback]
		delegate void CursorEventSignalDelegate (IntPtr arg0, ref Clutter.Geometry arg1, IntPtr gch);

		static void CursorEventSignalCallback (IntPtr arg0, ref Clutter.Geometry arg1, IntPtr gch)
		{
		...
		[GLib.CDeclCallback]
		delegate void CursorEventVMDelegate (IntPtr entry, ref Clutter.Geometry geometry);

		static CursorEventVMDelegate CursorEventVMCallback;

		static void cursorevent_cb (IntPtr entry, ref Clutter.Geometry geometry)
		{
			Entry entry_managed = GLib.Object.GetObject (entry, false) as Entry;
			entry_managed.OnCursorEvent (geometry);
		}
