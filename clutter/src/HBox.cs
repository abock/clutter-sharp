...
#region Autogenerated code
	public  class HBox : Clutter.Box, Clutter.Layout {
		...
		[DllImport("clutter")]
		static extern IntPtr clutter_hbox_new();

		public HBox () : base (IntPtr.Zero)
		{
			if (GetType () != typeof (HBox)) {
				CreateNativeObject (new string [0], new GLib.Value[0]);
				return;
			}
			Raw = clutter_hbox_new();
		}

		[DllImport("clutter")]
		static extern IntPtr clutter_hbox_get_type();

		public static new GLib.GType GType { 
			get {
				IntPtr raw_ret = clutter_hbox_get_type();
