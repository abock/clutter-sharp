...
#region Autogenerated code
	public  class BehaviourBspline : Clutter.Behaviour {
		...
		[GLib.CDeclCallback]
		delegate void KnotReachedVMDelegate (IntPtr bsplineb, ref Clutter.Knot knot);

		static KnotReachedVMDelegate KnotReachedVMCallback;

		static void knotreached_cb (IntPtr bsplineb, ref Clutter.Knot knot)
		{
			BehaviourBspline bsplineb_managed = GLib.Object.GetObject (bsplineb, false) as BehaviourBspline;
			bsplineb_managed.OnKnotReached (knot);
		}
