...
public class TestEvents
{
 	...
 	public static void Main ()
	{
		...
		/* Clutter stage */
		GtkClutter widget = new GtkClutter ();
		...
		Texture texture = new Texture (pixbuf);
		app.hand = texture;
		app.stage.Add (texture);
		uint width, height;
		...
		app.stage.Add (app.clutter_entry);
		...
		x_button.ValueChanged += delegate { app.hand.RotateX ((float)app.x_button.Value, (int)app.hand.Height, 0); };
		...
		y_button.ValueChanged += delegate { app.hand.RotateY ((float)app.y_button.Value, (int)app.hand.Width/2, 0); };
		...
		z_button.ValueChanged += delegate { app.hand.RotateZ ((float)app.z_button.Value, (int)app.hand.Width/2, (int)app.hand.Height/2); };
